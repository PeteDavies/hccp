...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/assets/css/topnavigation.css">
        
        <link href='http://fonts.googleapis.com/css?family=Duru+Sans' rel='stylesheet' type='text/css'>
        <script src="http://code.jquery.com/jquery-latest.min.js" type="text/javascript"></script>
        <script src="/assets/scripts/lean-slider.js" type="text/javascript"></script>
        <script src="/assets/scripts/galleria/galleria-1.4.2.min.js" type="text/javascript"></script>
        <link rel="stylesheet" href="/assets/css/lean-slider.css">
        <link rel="stylesheet" href="/assets/css/sample-styles.css">
        <title>Holmes Chapel Pre-School</title>
    </head>
